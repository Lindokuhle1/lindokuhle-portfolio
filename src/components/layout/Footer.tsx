...
export function Footer() {
  ...
  const socialLinks = [
    ...
    {
      icon: Mail,
      href: 'mailto:lindokuhlengcongo@outlook.com',
      label: 'Email',
    },
  ];
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          {socialLinks.map((social) => {
            ...
            return (
              <motion.a
                ...
                className="p-3 bg-dark-800 hover:bg-primary-500/20 border border-dark-700 hover:border-primary-500 rounded-lg transition-all"
        ...
        <div className="text-center py-8 border-t border-dark-800/50">
          <p className="text-dark-500 text-sm">
            © {currentYear} Lindokuhle Ngcongo. All rights reserved.
          </p>
